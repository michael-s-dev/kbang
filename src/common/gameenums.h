...
enum PlayingCardType {
    ...
    CARD_PUGNO,
    CARD_SOMBRERO,
    CARD_PLACCA_DI_FERRO,
    CARD_BIBBIA,
    CARD_PONY_EXPRESS,
    CARD_BORRACCIA,
    CARD_CONESTOGA,
    CARD_CAN_CAN,
    CARD_FUCILE_DA_CACCIA,
    CARD_DERRINGER,
    CARD_PUGNALE,
    CARD_PEPPERBOX,
    CARD_HOWITZER,
...
enum CharacterType {
    ...
    CHARACTER_JOSE_DELGADO,
    CHARACTER_KING_SCHULTZ,
    CHARACTER_CHUCK_WENGAM,
    CHARACTER_PAT_BRENNAN,
    CHARACTER_TEQUILA_JOE,
    CHARACTER_BILL_NOFACE,
    CHARACTER_SEAN_MALLORY,
    CHARACTER_HERB_HUNTER,
    CHARACTER_GREG_DIGGER,
    CHARACTER_ELENA_FUENTE,
    CHARACTER_MOLLY_STARK,
    CHARACTER_DOC_HOLYDAY,
    CHARACTER_APACHE_KID,
    CHARACTER_BELLE_STAR
};
