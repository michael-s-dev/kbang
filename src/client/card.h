...
private:
     ...
     */
    Card(const QString& name, PlayingCardType, const QString& imageFileName , const QString& imageFileName2 = "");
...
public:
    ...
    inline QPixmap image2() const { return m_image2; } ///< Returns image pixmap.
