...
public: /* The GameEventListener interface */
    ...
    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard* card , PocketType pocketFrom);
    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard* card, PublicPlayerView& target , PocketType pocketFrom);
    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard* card, const PlayingCard* target, PublicPlayerView* targetPlayer , PocketType pocketFrom);
    ...
    virtual void onPlayerRespondWithCard(PublicPlayerView&, const PlayingCard* card ,PocketType pocketFrom);
