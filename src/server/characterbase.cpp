...
{
    if  ( card->suit() == SUIT_DIAMONDS && targetPlayer->characterType() == CHARACTER_APACHE_KID && mp_player->isOnTurn()){
...
void CharacterBase::playCard(PlayingCard* card, PlayingCard* targetCard , PlayingCard* targetCard2)
{
    card->play(targetCard , targetCard2);
}
