...
public:
    ...
    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard* card , PocketType pocketFrom) = 0;

    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard* card, PublicPlayerView& target , PocketType pocketFrom) = 0;

    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard* card, const PlayingCard* target, PublicPlayerView* targetPlayer , PocketType pocketFrom) = 0;
    ...
    virtual void onPlayerRespondWithCard(PublicPlayerView&, const PlayingCard* card, PocketType pocketFrom ) = 0;
