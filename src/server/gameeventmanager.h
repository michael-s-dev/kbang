...
public:
    ...
    void onPlayerPlayCard(Player*, PlayingCard* , PocketType pocketFrom);

    void onPlayerPlayCard(Player*, PlayingCard*, Player* targetPlaye , PocketType pocketFrom);

    void onPlayerPlayCard(Player*, PlayingCard*, PlayingCard* targetCard , PocketType pocketFrom);
    ...
    void onPlayerRespondWithCard(Player*, PlayingCard* , PocketType pocketFrom);
