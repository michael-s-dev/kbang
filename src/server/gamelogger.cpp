...
void GameLogger::onPlayerPlayCard(PublicPlayerView& p, const PlayingCard* c , PocketType)
{
...
void GameLogger::onPlayerPlayCard(PublicPlayerView& p, const PlayingCard* c, PublicPlayerView& tp , PocketType)
{
...
void GameLogger::onPlayerPlayCard(PublicPlayerView& p, const PlayingCard* c, const PlayingCard* tc, PublicPlayerView* tp , PocketType)
{
...
void GameLogger::onPlayerRespondWithCard(PublicPlayerView& p, const PlayingCard* c , PocketType)
{
