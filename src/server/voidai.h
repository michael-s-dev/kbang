...
public:
    ...
    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard* , PocketType) {}
    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard*, PublicPlayerView& , PocketType) {}
    virtual void onPlayerPlayCard(PublicPlayerView&, const PlayingCard*, const PlayingCard*, PublicPlayerView* ,PocketType) {}
    ...
    virtual void onPlayerRespondWithCard(PublicPlayerView&, const PlayingCard* , PocketType) {}
